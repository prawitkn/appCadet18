...
?>
  ...
  <div class="content-wrapper">
    ...
    <div class="box box-primary">
        ...
        <h3 class="box-title">Edit Person : <?=$row['fullname'];?></h3>
            ...
            <div class="row">                
					...
					<div class="col-md-6">	
						<div class="form-group">
                            ...
                            <input type="text" id="title" name="title" class="form-control" value="<?=$row['title'];?>" data-smk-msg="Require title" required>
                        </div>
						<div class="form-group">
						...
						<div class="form-group">
                            ...
                            <input type="text" id="surname" name="surname" class="form-control" value="<?=$row['surname'];?>" data-smk-msg="Require surname" required>
                        </div>
						<div class="form-group">
						...
						<div class="form-group">
                            ...
                            <input type="text" id="mobileNo" name="mobileNo" class="form-control" value="<?=$row['mobileNo'];?>" />
                        </div>
						<div class="form-group">
						...
						<div class="form-group">
                            ...
                            <input type="text" id="group2code" name="group2code" class="form-control" value="<?=$row['group2code'];?>" />
                        </div>
						<div class="form-group">
                            <label for="group2Name" style="color: blue;">group2Name</label>
                            <input type="text" id="group2Name" name="group2Name" class="form-control" value="<?=$row['group2Name'];?>" />
                        </div>
						<div class="form-group">
                            <label for="retireYear" style="color: blue;">retireYear</label>
                            <input type="text" id="retireYear" name="retireYear" class="form-control" value="<?=$row['retireYear'];?>" />
                        </div>
					</div>
					<!--/.col-md-->
					<div class="col-md-6">
